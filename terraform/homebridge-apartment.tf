resource "vsphere_virtual_machine" "homebridge-apartment" {
  name             = "homebridge-apartment"
  tags             = [vsphere_tag.homebridge.id]
  ...
  clone {
    ...
    customize {
      ...
      linux_options {
        host_name = "homebridge-apartment"
